...
pub struct RegimeDetector {
    adx: Adx,
    chop: Chop,
    atr_short: Atr, // period 14 — current volatility
    atr_long: Atr,  // period 50 — baseline volatility
    // Thresholds
...
impl RegimeDetector {
    ...
    pub fn reset(&mut self) {
        self.adx = Adx::new(14);
        self.chop = Chop::new(14);
        self.atr_short = Atr::new(14);
        self.atr_long = Atr::new(50);
    }
}
