...
impl Uo {
    ...
    pub fn description() -> &'static str {
        "Ultimate Oscillator — combines three timeframes of buying pressure / true range into one oscillator. Reduces false divergence signals. Outputs a single 0–100 value."
    }
