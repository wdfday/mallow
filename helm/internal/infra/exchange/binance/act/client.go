...
// Client is a stateless Binance spot HTTP client.
// One instance is shared across all Binance spot accounts; credentials are passed per-call.
type Client struct {
...
// New creates a shared stateless Binance spot client.
