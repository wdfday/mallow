...
func orchWithCapital(capital float64) *helmdomain.HelmConfig {
	return &helmdomain.HelmConfig{
		ID:      uuid.New(),
		Capital: capital,
	}
}
...
func TestCheckCapitalAllocation_USD_ExcludesUpdatedBot(t *testing.T) {
	...
	if err := checkCapitalAllocation(orch, bots, posUSD(8_000), botID("bot1").String()); err != nil {
...
func TestCheckCapitalAllocation_USD_ExcludedBot_StillExceedsTotal(t *testing.T) {
	...
	err := checkCapitalAllocation(orch, bots, posUSD(7_000), botID("bot1").String())
	if err == nil {
...
func TestCheckCapitalAllocation_Pct_ExcludesUpdatedBot(t *testing.T) {
	...
	if err := checkCapitalAllocation(orch, bots, posPct(0.75), botID("bot1").String()); err != nil {
		t.Fatalf("expected nil when excluding updated bot, got %v", err)
	}
}
...
func TestCheckCapitalAllocation_Pct_ExcludeButStillExceeds(t *testing.T) {
	...
	err := checkCapitalAllocation(orch, bots, posPct(0.60), botID("bot1").String())
	if err == nil {
...
func TestCheckCapitalAllocation_EmptyExistingBots_USD_Passes(t *testing.T) {
	orch := orchWithCapital(10_000)
	if err := checkCapitalAllocation(orch, []domain.HandSummary{}, posUSD(9_999), ""); err != nil {
