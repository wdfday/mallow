...
// Config holds process-level orchestrator configuration.
//
// Important boundary:
//   - Per-account execution/broker settings belong to persisted orchestrator configs in the domain layer.
